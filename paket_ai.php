...
<body>
  ...
  <nav class="navbar navbar-expand-lg fixed-top">
    <div class="container-fluid">
      ...
      <?php if(isset($_SESSION['id_user'])): ?>
        <span style="margin-right: 15px; font-size: 14px;">Hi, <?php echo htmlspecialchars($_SESSION['nama']); ?></span>
  ...
  <div class="content">
    ...
    <img src="https://cdn.pixabay.com/photo/2017/05/10/19/29/robot-2301646_1280.jpg" alt="<?php echo htmlspecialchars($paket['nama_paket']); ?>">
