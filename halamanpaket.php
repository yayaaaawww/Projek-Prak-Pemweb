...
<div class="navbar">
    ...
    <div class="card-body">
        ...
        <div class="row align-items-start">
            ...
            <div class="col">
            <img src="./gambar/paketWEB.png" alt="paket web" style="width: 250px; margin-top: 50px;">
            </div>
        </div>
        </div>
    ...
    <div class="card-body">
        ...
        <div class="col">
            <img src="./gambar/paketDS.png" alt="paket DS" style="width: 250px; margin-top:50px;">
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        ...
        <div class="container text-center">
            <div class="row align-items-start">
                ...
                <div class="col">
                    <img src="./gambar/paketAI.png" alt="paket AI dan ML" style="width: 250px;">
                </div>
            </div>
        </div>
