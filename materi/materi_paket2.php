...
$id_paket_required = 2; // Paket 2: Data Science Pro
...
if ($stmt) {
    ...
    if (!$d) {
        echo "<script>alert('Akses ditolak! Kamu belum membeli Paket 2.'); window.location='../pembayaran.php?id_paket=2';</script>";
        exit();
    }
} else {
